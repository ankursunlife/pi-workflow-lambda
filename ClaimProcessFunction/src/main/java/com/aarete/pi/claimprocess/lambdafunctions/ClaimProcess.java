 ...
 */
public class ClaimProcess implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
	...
	public APIGatewayProxyResponseEvent claimProcessRequest(APIGatewayProxyRequestEvent input, Context context) {
