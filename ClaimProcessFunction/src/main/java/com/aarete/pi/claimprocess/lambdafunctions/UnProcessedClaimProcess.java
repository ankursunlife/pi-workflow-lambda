 ...
 */
public class UnProcessedClaimProcess implements RequestHandler<SQSEvent, SQSBatchResponse> {
	...
	public UnProcessedClaimProcess() {
		try {
	...
	public SQSBatchResponse handleRequest(SQSEvent sqsEvent, Context context) {
		...
		for (SQSEvent.SQSMessage message : sqsEvent.getRecords()) {
			try {
				...
				ClaimProcessHelper.processUnProcessedClaim(message.getBody());
			} catch (Exception e) {
