 ...
 */
public class ClaimOverrideProcess implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
	...
	public APIGatewayProxyResponseEvent claimOverrideProcessRequest(APIGatewayProxyRequestEvent input, Context context) {
